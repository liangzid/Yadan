"""
This raw python script coming from `rust-bert`, copyright by guillaume-be.
You mind click blew link for finding updations.
https://github.com/guillaume-be/rust-bert/blob/master/utils/convert_model.py
                       2022. 03. 23
"""
...
if __name__ == "__main__":
    ...
    subprocess.run(
        ['cargo', 'run', '--bin=convert-utils', '--manifest-path=%s' % toml_location, '--', source, target],
    )
